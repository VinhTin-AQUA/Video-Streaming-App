...
namespace API_Gateway.Clients
{
    public class VideoStreamingClient
    {
        ...
        public async Task<DashManifestContentDto> GetDashManifest(string videoId, string fileName)
        {
        ...
        public async Task<DashChunksDto> GetDashChunks(string videoId, string fileName)
        {
